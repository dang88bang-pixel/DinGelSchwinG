...
für das mobile Gateway (NFC-Helfer, BLE-Token-Tools). Spiegelt
`desktop/utils/retry.py` – bewusst dupliziert, damit `mobile-server/`
eigenständig lauffähig bleibt (kein pip-Paket, nur Stdlib).
"""
